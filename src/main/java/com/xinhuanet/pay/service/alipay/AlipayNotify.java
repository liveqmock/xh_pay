package com.xinhuanet.pay.service.alipay;
...
import com.xinhuanet.pay.service.impl.HttpClient4ServiceImpl;
 ...
 */
@Component
public class AlipayNotify extends Base{
    ...
    */
    private String checkUrl(String urlvalue) {
        String inputLine = "";
        try {
//        	HttpClient4Service clientService = new HttpClient4ServiceImpl();
        	inputLine = clientService.getResponeResult(urlvalue);
        } catch (Exception e) {
            e.printStackTrace();
            inputLine = "";
        }
