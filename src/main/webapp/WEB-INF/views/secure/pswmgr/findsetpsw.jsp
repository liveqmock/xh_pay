        ...
        <div class="safe-con">
			...
			<div class="mail-con">
				<form action="<c:url value="/pswmgr/savepsw.do" />" id="space-form" method="post">
					<input type="hidden" name="findpsw" value="secure/pswmgr/findsuccess" />
					<div class="reset-con">
						<p><span class="reset-tilte">电子邮件：</span><span class="reset-account">${account.email }</span></p>
						<p><span class="reset-tilte reset-psdcon">新的支付密码：</span><input id="new-psd" type="password" name="paypsw"/><span class="psd-tips">(请输入8位或以上字符)</span></p>
